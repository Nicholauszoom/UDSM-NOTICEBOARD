...
/*--------------------------------------------------------------*/
 ...
 function updateLastLogIn($user_id)
  ...
  function join_product_table(){
     global $db;
     $sql  =" SELECT p.id,p.name,p.quantity,p.description,p.buy_price,p.sale_price,p.media_id,p.date,c.name";
 ...
 /*--------------------------------------------------------------*/
  ...
  //  }
     ...
     /*--------------------------------------------------------------*/
   /* Function for Finding all department name
   /* JOIN with categorie  and media database table
   /*--------------------------------------------------------------*/
  function join_categorie_table(){
     global $db;
     $sql  =" SELECT c.id,c.name,k.cos_name";
    // $sql  .=" AS categorie,m.file_name AS image,s.supplier_name AS supplie";
    $sql  .=" AS course";
    $sql  .=" FROM categories c";
    $sql  .=" LEFT JOIN course k ON k.id = c.course_id";
    // $sql  .=" LEFT JOIN supplier s ON s.id = p.supplier_id";
   ...
   /*--------------------------------------------------------------*/
   /* Function for Finding all purchase name
   /* JOIN with product  and media database table
   /*--------------------------------------------------------------*/
  function join_purchase_table(){
    global $db;
    $sql  =" SELECT b.id,b.quantity,b.buy_price, p.name";
   $sql  .=" AS product_Item ";
   $sql  .=" FROM purchase b";
   ...
   /*--------------------------------------------------------------*/
  /* Function for Finding all supplier 
  /* Request coming from ajax.php for auto suggest
  /*--------------------------------------------------------------*/
//   function find_all_supplier(){
//     global $db;
//     $results = array();
//     $sql = "SELECT s.id,s.supplier_name,s.supplier_email,s.supplier_phone";
//     // $sql .="g.group_name ";
//     $sql .="FROM supplier s ";
//     // $sql .="LEFT JOIN user_groups g ";
//     // $sql .="ON g.group_level=u.user_level ORDER BY u.name ASC";
...
// }
 ...
 /*--------------------------------------------------------------*/
 /* Function for find all supplier
 /*--------------------------------------------------------------*/
 function find_all_supplier(){
  global $db;
  $sql  = "SELECT s.id,s.supplier_name,s.supplier_email,s.supplier_phone";
...
//   global $db;
//   $sql  = "SELECT b.id,b.qty,b.price,b.date,p.name";
//   $sql .= " FROM purchase b";
//   $sql .= " LEFT JOIN products p ON b.product_id = p.id";
