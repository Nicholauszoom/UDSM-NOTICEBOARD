...
<!-- link for slide videos -->
 <!-- Bootstrap CSS -->
 <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">  


<!----Animate on scroll link Website link " https://michalsnik.github.io/aos/ "-->
...
<!----BoxIcons CSS Link-->
<!----Box icons website link-----https://boxicons.com/usage   --->
...
<link href="https://fonts.googleapis.com/css2?family=Poppins:wght@200;300;400;600;700&family=Roboto:ital,wght@0,500;0,700;0,900;1,400&display=swap" rel="stylesheet">
      ...
      <div class="container">
        <div class="relative -mx-4 flex items-center justify-between">
          <div class="w-60 max-w-full px-4">
            <a href="index.html" class="navbar-logo block w-70 py-5">
              <img
                src="https://www.udsm.ac.tz/web/themes/udsm/layouts/main/img/logo_ud.png"
                alt="logo"
                class="header-logo w-70"
              />
            </a>
          </div>
        ...
        <div class="-mx-4 flex flex-wrap items-center">
          <div class="w-full px-4">
            ...
            >
              ...
              >
               UDSM ANNOUCEMENT MANAGEMENT SYSTEM
              </h1>
              ...
              <ul class="mb-10 flex flex-wrap items-center justify-center">
                ...
                <li>
                  ...
                  >
                  Developers View Code Structure
                    <span class="pl-2">
                      <svg
                        width="20"
                        height="8"
              ...
              <!-- <video class="video-slide active" src="uploads/video/udsmnt.mp4" autoplay muted loop></video> -->
      <!-- <video class="video-slide" src="uploads/video/uss.mp4" autoplay muted loop></video> -->
      <!-- <video class="video-slide" src="uploads/video/flowbite.mp4" autoplay muted loop></video> -->
            ...
            <div class="w-full px-4">
              ...
              >
                ...
                >
                  ...
                  >
                   The Important information Concern Our Plans and Activities
                  </h2>
                  <p class="mb-9 text-base leading-relaxed text-body-color">
                    The main ‘thrust' is to focus on educating attendees on how
                    to best protect and provide recently annoucements with
                    interactive panel discussions and roundtables led by subject
                    matter inside the university .
                  </p>
                  <p class="mb-9 text-base leading-relaxed text-body-color">
                    The main ‘thrust' is to focus on educating attendees on how
                    to best protect highly vulnerable with interactive panel.
                ...
                <div class="text-center">
                  <div class="relative z-10 inline-block">
                    <img
                    src="https://img.freepik.com/free-vector/call-center-concept-flat-design_52683-16593.jpg?size=626&ext=jpg&ga=GA1.2.723069760.1683881800&semt=ais"
                      alt="image"
...
<script type="text/javascript">
    ...
    <!----Animte on scroll JS link-->
    <script src="https://unpkg.com/aos@2.3.1/dist/aos.js"></script>
    <script src="/Js/app.js"></script>  <!----Also link the js File of animate on scroll link-->
